...
namespace EnglishBySongs.Controls.Behaviors
{
    public class LongPressBehavior : Behavior<StackLayout>
    {
        ...
        protected override void OnAttachedTo(StackLayout button)
        {
        ...
        protected override void OnDetachingFrom(StackLayout button)
        {
